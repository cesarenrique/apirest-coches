...
class TemporadaController extends ApiController
{
    ...
    public function store(Request $request)
    {
        ...
        $Agencia=Agencia::findOrFail($request->Agencia_id);
    ...
    public function pertenece(Request $request,$Agencia_id){
      $rules=[
        'fecha_desde'=> 'required',
        'fecha_hasta'=> 'required',
      ];
    ...
    public function puedeReservarse(Request $request,$Agencia_id){
      $rules=[
        'fecha_desde'=> 'required',
        'fecha_hasta'=> 'required',
      ];
      ...
      $this->validate($request,$rules);
      $valido=$this->puedeReservarseValidar($Agencia_id,$request->fecha_desde,$request->fecha_hasta);
      return $this->showOne2($valido);
    }



  public function extraerIdTemporada($Agencia_id,$fecha_desde,$fecha_hasta){
