 ...
 *     @SWG\Info(
 *         version="1.0.0",
 *         title="API REST Agenciaes",
 *         description="API REST Agenciaes",
 *         @SWG\Contact(
 ...
 * 			@SWG\Property(property="AgenciaIdentificador", type="integer", example=1),
 *      @SWG\Property(property="fechaCreacion", type="string", example="2021-10-11"),
 *      @SWG\Property(property="fechaActualizacion", type="string", example="2021-10-11"),
 *      @SWG\Property(property="fechaEliminacion", type="string", example="null")
 * 		),
 ...
 * 			@SWG\Property(property="nombre", type="string", example="Reynods Agencia"),
 ...
 * 			@SWG\Property(property="AgenciaIdentificador", type="integer", example=68),
 *      @SWG\Property(property="fechaCreacion", type="string", example="2021-10-11"),
 *      @SWG\Property(property="fechaActualizacion", type="string", example="2021-10-11"),
 *      @SWG\Property(property="fechaEliminacion", type="string", example="null")
 * 		),
...
class ApiController extends Controller
{
    ...
    public function puedeReservarseValidar($Agencia_id,$fecha_desde,$fecha_hasta){
      ...
      $cantidad=DB::select("select count(DISTINCT a.abierto) as 'cantidad' from fechas a where a.abierto>='".date_format($fecha,'Y-m-d')."' and '".date_format($fecha2,'Y-m-d')."'>=a.abierto and a.Agencia_id=".$Agencia->id);
