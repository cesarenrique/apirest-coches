...
class TipoCocheController extends ApiController
{
  ...
  /**
     ...
     *     @SWG\Schema(
     *         type="array",
     *         @SWG\Items(ref="#definitions/TipoCoche")
     *     )
     *   ),
     ...
     *      @SWG\Schema(ref="#definitions/TipoCoche")
     *   ),
     *   @SWG\Response(response=403, description="Autorization Exception",
     *      @SWG\Schema(ref="#definitions/Errors403")
     *   ),
    ...
    public function store(Request $request)
    {
        $rules=[
          'tipo'=> 'required',
          'Agencia_id'=> 'required|exists:hotels,id',
        ];
        $this->validate($request,$rules);
        $campos=$request->all();
        $tipohab=TipoCoche::create($campos);
    ...
    {
        $tipohab=TipoCoche::findOrFail($id);
