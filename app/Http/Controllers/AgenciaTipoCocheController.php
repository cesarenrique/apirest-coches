...
class AgenciaTipoCocheController extends ApiController
{
  ...
  /**
     ...
     */
     ...
     /**
     * @SWG\Get(
     *   path="/Agencias/{Agencia_id}/tipo_habitacions",
     *   security={
     *     {"passport": {}},
     *   },
     *   summary="Get Agenciaes tipos habitaciones",
     *		  @SWG\Parameter(
     *          name="Agencia_id",
     *          in="path",
     *          required=true,
