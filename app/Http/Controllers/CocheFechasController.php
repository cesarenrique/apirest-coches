...
class CocheFechasController extends ApiController
{
     ...
     **/
          ...
          /**
          * @SWG\Get(
          *   path="/Coches/{Coche_id}/fechas",
          *   security={
          *     {"passport": {}},
          *   },
          *   summary="Get Coche table All Fechas",
          *     @SWG\Parameter(
          *         name="Autorization",
          *         in="header",
          *         required=true,
    ...
    /**
     * En funcion de rango dice que dias esta libre una Coche
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
     ...
     /**
     * @SWG\Get(
     *   path="/Coches/{Coche_id}/fechas/libre",
     *   security={
     *     {"passport": {}},
     *   },
     *   summary="Get Coche table All Fechas",
    ...
    public function libre(Request $request,$id)
    {
      ...
      $Agencia=Agencia::findOrFail($Coche->Agencia_id);
      $fechas=$Agencia->fechas->whereBetween('abierto',[$fecha_desde,$fecha_hasta]);
      $reservas=$Coche->reservas;
      $previos=collect();
     ...
     */
     ...
     /**
     * @SWG\Get(
     *   path="/Coches/{Coche_id}/fechas/ocupado",
     *   security={
     *     {"passport": {}},
     *   },
     *   summary="Get Coche table All Fechas",
