...
<script>
    export default {
        ...
        methods: {
             ...
             */
            getClients() {
                axios.get('/apirest-coches/public/oauth/clients')
                        .then(response => {
            ...
            store() {
                this.persistClient(
                    'post', '/apirest-coches/public/oauth/clients',
            ...
            update() {
                this.persistClient(
                    'put', '/apirest-coches/public/oauth/clients/' + this.editForm.id,
             ...
             */
            destroy(client) {
                axios.delete('/apirest-coches/public/oauth/clients/' + client.id)
                        .then(response => {
                            this.getClients();
                        });
            }
